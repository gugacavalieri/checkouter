...
class Pix extends React.PureComponent {
  componentDidMount = () => {
    const {
      callbacks,
    ...
    return (
      <section className={theme.wrapper}>
        <header className={theme.header}>
          <h1 className={theme.title}>PIX</h1>
          {
            subtitle &&
        ...
        <div className={theme.content}>
          ...
          <p className={theme.warning}>
            Ao continuar, seu código PIX será criado para
...
export default
connect(mapStateToProps, mapDispatchToProps)(consumeTheme(Pix))
